...
-->
        ...
        if(navigator.onLine) {
          window.addEventListener('load', function() {
            var toastHtml = '<img id="toastImg" src="<?php echo ''.$sponTabStmt[$randSpon][2];?>" class="imgPadBr"><a id="toastA" href="<?php echo ''.$sponTabStmt[$randSpon][3];?>" target="_blank"><p>site web de <?php echo ''.strtoupper($sponTabStmt[$randSpon][1]);?></p></a>';
