...
<html lang="fr">
    <head>
        ...
        <meta name="description" content="B-boost, programme du 14 octobre">
        <meta name="keywords" content="B-boost, open source, salon,open source, La Rochelle, programme, 14 octobre">
        <meta name="author" content="Chlo">
        <title>B-boost, le programme du 14 octobre</title>
        <?php
        include("header.php");
        ?>
    </head>
    ...
    <body>
      ...
      <div class="container" id="begin">
        <div class="row hide-on-small-only">
          <div class="col s8 m4 l2 offset-m4 offset-l5"><h2 class="center-align">14 octobre</h2></div>
          <div class="col s1 m1 l1 offset-s1 offset-m2 offset-l4">
            <a href="programme15.php" class="">
              <div class="valign-wrapper">
                <div class=""><h2 class="">15</h2></div>
                <div class=""><i class="fas fa-chevron-right fa-2x"></i></div>
                <!-- <div class=""><i class="material-icons medium">navigate_next</i></div> -->
              </div>
            </a>
          </div>
        </div>
        <div class="row hide-on-med-and-up">
          <div class="col s8 m4 l2 offset-m4 offset-l5"><h2 class="">14 octobre</h2></div>
        ...
        <table id="s1" class="striped"><!--class="striped centered responsive-table"-->
         ...
         <tbody>
           <tr>
             <td>09h30</td>
             <td>
               <a id="111" href="<?php echo 'programme.php?num=111'; ?>">
                 <?php
           ...
           <tr>
             <td>10h30</td>
             <td>
               <a id="121" href="<?php echo 'programme.php?num=121'; ?>">
                  <?php
           ...
           <tr>
             <td>11h30</td>
             <td>
               <a id="131" href="<?php echo 'programme.php?num=131'; ?>">
                 <?php
           ...
           <tr>
             <td>14h00</td>
             <td>
               <a id="141" href="<?php echo 'programme.php?num=141'; ?>">
                 <?php
           ...
           <tr>
             <td>15h00</td>
             <td>
               <a id="151" href="<?php echo 'programme.php?num=151'; ?>">
                 <?php
           ...
           <tr>
             <td>16h00</td>
             <td>
               <a id="161" href="<?php echo 'programme.php?num=161'; ?>">
                 <?php
        ...
        <table id="s2" class="striped">
          ...
          <tbody>
            <tr>
              <td>09h30</td>
              <td>
                <a id="112" href="<?php echo 'programme.php?num=112'; ?>">
                  <?php
            ...
            <tr>
              <td>10h30</td>
              <td>
                <a id="122" href="<?php echo 'programme.php?num=122'; ?>">
                  <?php
            ...
            <tr>
              <td>11h30</td>
              <td>
                <a id="132" href="<?php echo 'programme.php?num=132'; ?>">
                  <?php
            ...
            <tr>
              <td>14h00</td>
              <td>
                <a id="142" href="<?php echo 'programme.php?num=142'; ?>">
                  <?php
            ...
            <tr>
              <td>15h00</td>
              <td>
                <a id="152" href="<?php echo 'programme.php?num=152'; ?>">
                  <?php
            ...
            <tr>
              <td>16h00</td>
              <td>
                <a id="162" href="<?php echo 'programme.php?num=162'; ?>">
                  <?php
        ...
        <table id="s3" class="striped">
         ...
         <tbody>
           <tr>
             <td>09h30</td>
             <td>
               <a id="113" href="<?php echo 'programme.php?num=113'; ?>">
                 <?php
           ...
           <tr>
             <td>10h30</td>
             <td>
               <a id="123" href="<?php echo 'programme.php?num=123'; ?>">
                 <?php
           ...
           <tr>
             <td>11h30</td>
             <td>
               <a id="133" href="<?php echo 'programme.php?num=133'; ?>">
                 <?php
           ...
           <tr>
             <td>14h00</td>
             <td>
               <a id="143" href="<?php echo 'programme.php?num=143'; ?>">
                 <?php
           ...
           <tr>
             <td>15h00</td>
             <td>
               <a id="153" href="<?php echo 'programme.php?num=153'; ?>">
                 <?php
           ...
           <tr>
             <td>16h00</td>
             <td>
               <a id="163" href="<?php echo 'programme.php?num=163'; ?>">
                 <?php
        ...
        <table id="s4" class="striped">
         ...
         <tbody>
           <tr>
             <td>09h30</td>
             <td>
               <a id="114" href="<?php echo 'programme.php?num=114'; ?>">
                 <?php
           ...
           <!-- <tr>
             <td>10h30</td>
             <td>
               <a id="124" href="<?php echo 'programme.php?num=124'; ?>">
                 <?php
           ...
           <!-- <tr>
             <td>11h30</td>
             <td>
               <a id="134" href="<?php echo 'programme.php?num=134'; ?>">
                 <?php
           ...
           <!-- <tr>
             <td>14h00</td>
             <td>
               <a id="144" href="<?php echo 'programme.php?num=144'; ?>">
                 <?php
           ...
           <tr>
             <td>15h00</td>
             <td>
               <a id="154" href="<?php echo 'programme.php?num=154'; ?>">
                 <?php
           ...
           <!-- <tr>
             <td>16h00</td>
             <td>
               <a id="164" href="<?php echo 'programme.php?num=164'; ?>">
                 <?php
