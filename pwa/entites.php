...
<html lang="fr">
    <head>
        ...
        <meta name="description" content="B-boost, les entités">
        <meta name="keywords" content="entités, B-boost,entreprises,collectivités, open source, salon, événement, La Rochelle, rencontres, business, stand, b to b, professionnel">
        <meta name="author" content="Chlo">
        <title>B-boost, les entités</title>
    ...
    <body>
      <?php
      if(isset($ent)){$a="pagesEn/entitesEn.php?ent=".$ent;}
      include("navbar.php");
      ?>
    <div>
      <p></p>
      ...
      <div class="container"><!--L'entreprise'-->
          ...
          <div class="col s12 m8 l8">
            <div class="row">
              <div class="col s9 m9 l9">
                ...
                <p><?php if(isset($stand) && $stand!=null){echo "Stand : ".$stand;}else{echo "Non exposant";}?></p>
              </div>
            ...
            <div class="row">
              <p class=""><?php if(isset($entTab) && $entTab[7]!=null){echo $manag->formatting($entTab[7]);}else{echo"A venir ...";} ?></p>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col s12 m3 l4">
            <div><p><b>Dirigeant : </b></p></div>
            <p><?php if(isset($persTab) && $persTab[1]!=null && $persTab[2]!=null){echo strtoupper($manag->filtreAccents($persTab[1]))." ".ucfirst($persTab[2]);} ?></p>
          </div>
          ...
          <div class="col s12 m3 l3 " >
            ...
            <div class="row">
              <!-- <div class="col s3 m2 l3 offset-s3"><a href="
                <?php
                // if(isset($entTab) && $entTab[11]!=null){echo $entTab[11];}
                ?>
                " target="_blank"><i class="fab fa-linkedin-in  fa-2x"></i></a></div>
              <div class="col s3 m2 l3 offset-s1 offset-m1"><a href="
                <?php
                // if(isset($entTab) && $entTab[10]!=null){echo $entTab[10];}
                ?>
                " target="_blank"><i class="fab fa-twitter  fa-2x"></i></a></div> -->
              <?php
