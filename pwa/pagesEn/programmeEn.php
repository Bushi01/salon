...
<html lang="en">
    <head>
        ...
        <meta name="description" content="B-boost, program">
        <meta name="keywords" content="program, B-boost, conference, round table, keynote, workshop, open source, salon, event, La Rochelle, tables rondes, ateliers, keynotes, conférences">
        <meta name="author" content="Chlo">
        <title>B-boost, program</title>
      ...
      <div class="container">
              ...
              <div class="col s12 m9 l7 offset-l1">
                ...
                <div class="col s m l">
                  ...
                  <h3 class=""><?php $manag->titreProgEn($slot[3]); ?></h3>
                </div>
                <div>
                  <p class="right-align"><img class="responsive-img img15" src="../<?php $manag->themeProg($slot[3]); ?>" alt="theme"></p>
                  <p class="right-align"><?php $manag->progTypeEn($slot[3]); ?></p>
                </div>
              </div>
                  <p class=""><?php if(isset($prog[5])&& !empty($prog[5])){echo $manag->formatting($prog[5]) ;}else{echo "Coming soon ...";} ?></p>
              </div>

              <?php echo '<a href="participantsEn.php?speak='.$speak.'">'?>
          ...
          <!-- <div class="row">
            <div class="col s12 m12 l10 offset-l1"> -->
              ...
              //     $inter = $manag->persTab($ligne[0]);
              //     $srcPhoto = $inter[3];
              //     $nomSpeak = strtoupper($inter[1]);
              //     $prenomSpeak = $manag->majuscule($inter[2]);
              //     echo '<a href="participantsEn.php?speak='.$inter[0].'">
              //             <div class="col s6 m2 l2">
              //               <div class=""><img src="../'.$srcPhoto.'" class="z-depth-4" alt="image participant"></div>
              //               <div class=""><h4><i>'.$nomSpeak.'</i></h4></div>
